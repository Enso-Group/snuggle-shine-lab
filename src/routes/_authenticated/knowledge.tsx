...
export const Route = createFileRoute("/_authenticated/knowledge")({
  head: () => ({ meta: [{ title: "Knowledge Base — WhatsApp Bot" }] }),
  beforeLoad: ({ context }) => {
  ...
  return (
    <div className="min-h-full">
      <PageHeader
        ...
        description="The only source the bot may quote business facts from — prices, policies, products, links. Anything not here, it says it will check."
          ...
          <CardContent className="p-5">
            <div className="mb-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-semibold">{editing ? "Edit item" : "Add knowledge"}</h2>
              </div>
              {editing && (
                <Button
                  variant="ghost"
                  ...
                  <div className="flex shrink-0 items-center gap-1.5">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (
                          window.confirm(
                            `Delete "${item.title}"? The bot will stop using it immediately.`,
                          )
                        )
