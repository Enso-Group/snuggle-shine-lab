    ...
    return (
      <div className="min-h-full">
        <PageHeader
          icon={SettingsIcon}
          title="Settings"
          description="Bot settings and Whapi connection"
        />
      ...
      <PageContent maxWidthClass="max-w-3xl">
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Setup and connection instructions moved to the <strong>Instructions</strong> page in
              the menu.
            </p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              How the bot talks and responds. Changes take effect immediately on new messages.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-3 border rounded-md">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  When off, it won't reply but will keep saving messages
                </p>
              </div>
            ...
            <div className="flex items-center justify-between p-3 border rounded-md border-amber-500/50 bg-amber-50/30 dark:bg-amber-950/10">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  When on, every message the bot wants to send (reply, scheduled, or manual) goes to
                  the "Approvals" page with send / edit / delete.
                </p>
              </div>
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                In groups, the bot replies only if someone mentions this name or tags it
              </p>
            </div>
            <div>
              ...
              />
              <p className="text-xs text-muted-foreground mt-1">
                Anti-ban tip: ask the bot to write short, natural messages with variety, and not to
